...
public class NonPremetativeDatatype {
	...
	public static void main(String[] args) {
		...
		NonPremetativeDatatype oof = new NonPremetativeDatatype();
		
		String obj = new String();  // This is an object / class
		
		String names = "Name"; // This is a data type / variable
		
		int nums = 200; // data type / variable
		
		
		// What is an array?
		// Ans: Array is an non primitive data type as well as its an object.
		...
		// Array use length method 
		// Array is faster & Non Synchronize( At a time we can run multiple program)
		// What happens if array value incremented?
		// Ans: we are getting an ArrayIndexOutOfBoundsException:

		// How to
		int[] num1 = new int[4]; // Concept of array
		num1[0] = 30;
		num1[1] = 35;
		num1[2] = 60;
		num1[3] = 90;
		num1[4] = 70; // <<<---- ArrayIndexOutOfBoundsException:
...
//			System.out.println("increment the value "+i);
	 ...
	 //How to reverse string "Infosys" Interview questions
		...
		String name[][] = { { "Mohana", "Shomik", "Shajib", "Norain" }, 
				            { "Fhamida", "Montasir" },
